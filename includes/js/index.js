...
class ContentToggleButton extends elementorModules.frontend.handlers.Base {
  ...
  onSwiperLoad() {
    ...
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper", {
      effect: effect,
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCards, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCube, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCreative],
      grabCursor: true,
      creativeEffect: {
        prev: {
          shadow: true,
